"""
Unit tests for the Zypper fetcher.
"""
...
from saidata_gen.fetcher import ZypperFetcher, ZypperDistribution


class TestZypperFetcher(unittest.TestCase):
    """
    Test cases for the Zypper fetcher.
    """
    ...
    def setUp(self):
        ...
        self.test_dist = ZypperDistribution(
            name="opensuse",
            version="15.4",
    ...
    def test_get_repository_name(self):
        ...
        self.assertEqual(self.fetcher.get_repository_name(), "zypper")
    
    @patch("saidata_gen.fetcher.zypper.ZypperFetcher._fetch_primary_location")
    @patch("saidata_gen.fetcher.zypper.ZypperFetcher._fetch_primary_xml")
    def test_fetch_repository_data(self, mock_fetch_primary_xml, mock_fetch_primary_location):
        ...
        mock_fetch_primary_location.assert_called_once_with("http://download.opensuse.org/distribution/leap/15.4/repo/oss/repodata/repomd.xml")
        mock_fetch_primary_xml.assert_called_once_with("http://download.opensuse.org/distribution/leap/15.4/repo/oss/repodata/primary.xml.gz")
    ...
    def test_get_package_info(self, mock_fetch_primary_xml, mock_fetch_primary_location):
        ...
        self.assertEqual(pkg_info.provider, "zypper")
    ...
    def test_get_package_details(self, mock_fetch_primary_xml, mock_fetch_primary_location):
        ...
        self.assertEqual(details.provider, "zypper")
