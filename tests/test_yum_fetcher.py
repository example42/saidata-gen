"""
Unit tests for the YUM fetcher.
"""
...
from saidata_gen.fetcher import YumFetcher, YumDistribution


class TestYumFetcher(unittest.TestCase):
    """
    Test cases for the YUM fetcher.
    """
    ...
    def setUp(self):
        ...
        self.test_dist = YumDistribution(
            name="centos",
            version="7",
    ...
    def test_get_repository_name(self):
        ...
        self.assertEqual(self.fetcher.get_repository_name(), "yum")
    
    @patch("saidata_gen.fetcher.yum.YumFetcher._fetch_primary_location")
    @patch("saidata_gen.fetcher.yum.YumFetcher._fetch_primary_xml")
    def test_fetch_repository_data(self, mock_fetch_primary_xml, mock_fetch_primary_location):
        ...
        mock_fetch_primary_location.assert_called_once_with("http://mirror.centos.org/centos/7/os/x86_64/repodata/repomd.xml")
        mock_fetch_primary_xml.assert_called_once_with("http://mirror.centos.org/centos/7/os/x86_64/repodata/primary.xml.gz")
    ...
    def test_get_package_info(self, mock_fetch_primary_xml, mock_fetch_primary_location):
        ...
        self.assertEqual(pkg_info.provider, "yum")
    ...
    def test_get_package_details(self, mock_fetch_primary_xml, mock_fetch_primary_location):
        ...
        self.assertEqual(details.provider, "yum")
